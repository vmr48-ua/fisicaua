...
\noindent En esta cuestión se nos pide calcular la cantidad de hidróxido de sodio (\ce{NaOH}) y agua (\ce{H2O}) necesarios para obtener una disolución $0.2 M$. A partir de la fórmula de la cuestión 1 ($M = \frac{n_{\text{soluto}}}{\si{L}_{\text{disolución}}}$) haremos el siguiente factor de conversión y obtendremos la respuesta:
