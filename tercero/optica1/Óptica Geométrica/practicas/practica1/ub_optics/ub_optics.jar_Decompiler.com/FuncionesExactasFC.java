public class FuncionesExactasFC {
   static int numSup;
   ...
   static int preparaSistema() {
      ...
      if (SistemaFC.existeObjeto[0] == 0) {
         ...
         numColores = ExactoFC.numColores;

         for(int var0 = 1; var0 < 7; ++var0) {
            if (SistemaFC.existe[var0] != 0) {
               if (SistemaFC.real[0] == 1 && SistemaFC.zObjeto[0] >= SistemaFC.valZE[var0] - ExactoFC.espesor[var0] / 2.0D && SistemaFC.zObjeto[0] <= SistemaFC.valZE[var0] + ExactoFC.espesor[var0] / 2.0D) {
                  ExactoFC.dibuja = 0;
                  return 0;
               }

               if (SistemaFC.real[0] != 1 || !(SistemaFC.zObjeto[0] > SistemaFC.valZE[var0])) {
                  ++var1;
                  ene[0][var1] = 1.0D;
                  if (numColores != 0) {
                  ...
                  if (SistemaFC.tipoE[var0] == 0) {
                     ExactoFC.dze1[var0] = 0.0D;
                     ExactoFC.dze2[var0] = 0.0D;
                     ExactoFC.dzb1[var0] = 0.0D;
                     ExactoFC.dzb2[var0] = 0.0D;
                     v[var1] = SistemaFC.valZE[var0];
                     curv[var1] = 0.0D;
                     r[var1] = 1.0E10D;
                     hmax[var1] = SistemaFC.altura[var0];
                     ene[0][var1 + 1] = 1.0D;
                     if (numColores != 0) {
                        ene[1][var1 + 1] = ene[2][var1 + 1] = 1.0D;
                     }
                  } else {
                     ExactoFC.dze1[var0] = -ExactoFC.espesor[var0] / 2.0D;
                     ExactoFC.dze2[var0] = ExactoFC.espesor[var0] / 2.0D;
                     v[var1] = SistemaFC.valZE[var0] + ExactoFC.dze1[var0];
                     curv[var1] = ExactoFC.curv1[var0];
                     r[var1] = ExactoFC.radio1[var0];
                     hmax[var1] = SistemaFC.altura[var0];
                     v[var1 + 1] = SistemaFC.valZE[var0] + ExactoFC.dze2[var0];
                     curv[var1 + 1] = ExactoFC.curv2[var0];
                     r[var1 + 1] = ExactoFC.radio2[var0];
                     hmax[var1 + 1] = SistemaFC.altura[var0];
                     ene[0][var1 + 1] = ExactoFC.indice[var0];
                     if (numColores != 1) {
                        double var2 = (ExactoFC.indice[var0] - 1.0D) / ExactoFC.abbe[var0];
                        ene[1][var1 + 1] = ExactoFC.indice[var0] + var2;
                        ene[2][var1 + 1] = ExactoFC.indice[var0] - var2;
                     }
   ...
   static int marchaParaxial() {
      ...
      if (SistemaFC.existeObjeto[0] == 0) {
         return 0;
      } else if (ExactoFC.dibuja == 0) {
         return 0;
      } else {
         double var3 = Math.tan(SistemaFC.campo[0] * 3.151592D / 180.0D);
         SistemaFC.valYObj[0] = d[0] * var3;
         double var5 = 0.0D;
         double var9 = var17;
   ...
   static int preparaRayos() {
      double var11 = 0.5D;
      double var13 = SistemaFC.zObjeto[0];
      double var15 = SistemaFC.valYObj[0];
      if (ExactoFC.dibuja == 0) {
         return 0;
      } else if (d[0] == 0.0D) {
         return 0;
      } else {
         double var9 = Math.abs(hmax[1] * ExactoFC.hpr[ExactoFC.nir] / d[0]);
         double var7;
         if (var9 > var11) {
            var7 = var11 / var9;
         } else {
         ...
         int var1;
         for(var1 = 0; var1 <= ExactoFC.nir; ++var1) {
            cmRayo[0][0][1][var1] = cmRayo[0][1][1][var1] = cmRayo[0][2][1][var1] = var3 * ExactoFC.hpr[var1] / d[0];
         ...
         for(var1 = ExactoFC.nir + 1; var1 <= ExactoFC.nir * 2; ++var1) {
            cmRayo[0][0][1][var1] = cmRayo[0][1][1][var1] = cmRayo[0][2][1][var1] = -var3 * ExactoFC.hpr[var1 - ExactoFC.nir] / d[0];
            dmRayo[0][0][1][var1] = dmRayo[0][1][1][var1] = dmRayo[0][2][1][var1] = -var13 * cmRayo[0][0][1][var1];
            pasam[0][0][0][var1] = pasam[0][1][0][var1] = pasam[0][2][0][var1] = 1;
         }

         for(var1 = 0; var1 <= ExactoFC.nir; ++var1) {
            cmRayo[1][0][1][var1] = cmRayo[1][1][1][var1] = cmRayo[1][2][1][var1] = (var3 * ExactoFC.hpr[var1] - var15) / d[0];
         ...
         for(var1 = ExactoFC.nir + 1; var1 <= ExactoFC.nir * 2; ++var1) {
            cmRayo[1][0][1][var1] = cmRayo[1][1][1][var1] = cmRayo[1][2][1][var1] = (-var3 * ExactoFC.hpr[var1 - ExactoFC.nir] - var15) / d[0];
            dmRayo[1][0][1][var1] = dmRayo[1][1][1][var1] = dmRayo[1][2][1][var1] = var15 - var13 * cmRayo[1][0][1][var1];
            pasam[1][0][0][var1] = pasam[1][1][0][var1] = pasam[1][2][0][var1] = 1;
         }

         for(var1 = 0; var1 < ExactoFC.numRayos; ++var1) {
            aRayo[0][0][1][var1] = aRayo[0][1][1][var1] = aRayo[0][2][1][var1] = var3 * ExactoFC.xpr[var1] / d[0];
            bRayo[0][0][1][var1] = bRayo[0][1][1][var1] = bRayo[0][2][1][var1] = -var13 * aRayo[0][0][1][var1];
            cRayo[0][0][1][var1] = cRayo[0][1][1][var1] = cRayo[0][2][1][var1] = var3 * ExactoFC.ypr[var1] / d[0];
            ...
            cRayo[1][0][1][var1] = cRayo[1][1][1][var1] = cRayo[1][2][1][var1] = (var3 * ExactoFC.ypr[var1] - var15) / d[0];
      ...
      if (ExactoFC.dibuja == 0) {
         ...
         for(var3 = 0; var3 < 2; ++var3) {
            for(var2 = 0; var2 < numColores; ++var2) {
               for(var1 = 0; var1 <= ExactoFC.nir * 2; ++var1) {
