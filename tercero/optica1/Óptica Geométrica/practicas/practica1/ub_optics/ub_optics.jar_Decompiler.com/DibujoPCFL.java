...
class DibujoPCFL extends Canvas {
   ...
   public DibujoPCFL(DibujoSistemaFL var1) {
   ...
   public void paint(Graphics var1) {
      ...
      for(var18 = 0; var18 < 2; ++var18) {
         FuncionesCardinalesFL.marchaParaxialCard(var18);
      }

      FuncionesCardinalesFL.normalizaCoeficientes();

      for(var18 = 0; var18 < 2; ++var18) {
         FuncionesCardinalesFL.interseccionesRayosCard(var18);
      }
      ...
      if (var5 >= 2) {
         ...
         for(var18 = 0; var18 < 2; ++var18) {
            ...
            byte var13 = 0;
            var16 = this.eje - (int)(AnteproyectoFL.bpRayoCard[var18][0] * 2.0D);
            short var14 = 800;
            if (AnteproyectoFL.apRayoCard[var18][0] == 0.0D) {
               var17 = var16;
            } else {
               var17 = this.eje - (int)((AnteproyectoFL.apRayoCard[var18][0] * 1600.0D + AnteproyectoFL.bpRayoCard[var18][0]) * 2.0D);
            }

            var29.drawLine(var13, var16, var14, var17);
            var2 = AnteproyectoFL.tramoCard[var5 - 1];
            var7 = AnteproyectoFL.tramoCard[var5];
            var13 = 0;
            var16 = this.eje - (int)(AnteproyectoFL.bpRayoCard[var18][var2] * 2.0D);
            var14 = 800;
            var17 = this.eje - (int)(AnteproyectoFL.yaRayoCard[var18][var7] * 2.0D);
            var29.drawLine(var13, var16, var14, var17);
         }
         ...
         for(var18 = 0; var18 < 2; ++var18) {
            ...
            for(int var4 = 0; var4 < var5; ++var4) {
               var2 = AnteproyectoFL.tramoCard[var4];
               var7 = AnteproyectoFL.tramoCard[var4 + 1];
               if (var2 == 0) {
                  var30 = 0;
                  var16 = this.eje - (int)(AnteproyectoFL.bpRayoCard[var18][0] * 2.0D);
               } else {
                  var30 = (int)(AnteproyectoFL.zpRayoCard[var18][var2] / 2.0D);
                  var16 = this.eje - (int)(AnteproyectoFL.ypRayoCard[var18][var2] * 2.0D);
               }

               int var31 = (int)(AnteproyectoFL.zaRayoCard[var18][var7] / 2.0D);
               var17 = this.eje - (int)(AnteproyectoFL.yaRayoCard[var18][var7] * 2.0D);
