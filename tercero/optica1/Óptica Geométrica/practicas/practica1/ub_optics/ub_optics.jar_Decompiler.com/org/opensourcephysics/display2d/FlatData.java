...
public class FlatData implements GridData {
   ...
   public FlatData(int var1, int var2, int var3) {
      if (var2 >= 1 && var1 >= 1) {
         if (var3 < 1) {
   ...
   public double getValue(int var1, int var2, int var3) {
      if (var1 >= 0 && var1 < this.nx) {
         if (var2 >= 0 && var2 < this.ny) {
            return this.data[(var2 * this.nx + var1) * this.stride + var3];
         } else {
   ...
   public void setValue(int var1, int var2, int var3, double var4) {
      if (var1 >= 0 && var1 < this.nx) {
         if (var2 >= 0 && var2 < this.ny) {
            this.data[(var2 * this.nx + var1) * this.stride + var3] = var4;
         } else {
            throw new IllegalArgumentException("y index out of range in getValue");
         }
      } else {
   ...
   public void setCenteredCellScale(double var1, double var3, double var5, double var7) {
      double var9 = this.nx > 1 ? (var3 - var1) / (double)(this.nx - 1) / 2.0D : 0.0D;
      var1 -= var9;
      var3 += var9;
      var9 = this.ny > 1 ? (var7 - var5) / (double)(this.ny - 1) / 2.0D : 0.0D;
      var5 -= var9;
      var7 += var9;
   ...
   public double interpolate(double var1, double var3, int var5) {
      ...
      var6 = Math.min(this.nx - 2, var6);
      int var7 = -((int)((this.top - var3) / this.dy));
      var7 = Math.max(0, var7);
      var7 = Math.min(this.ny - 2, var7);
      double var8 = (var1 - this.left) / this.dx - (double)var6;
      double var10 = -(this.top - var3) / this.dy - (double)var7;
      int var12;
      if (var6 < 0) {
         var12 = this.nx * var7 * this.stride + var5;
         return (1.0D - var10) * this.data[var12] + var10 * this.data[var12 + this.nx * this.stride];
      } else if (var7 < 0) {
         var12 = var6 * this.stride + var5;
         return (1.0D - var8) * this.data[var12] + var8 * this.data[var12 + this.stride];
      } else {
         var12 = this.nx * var7 * this.stride + var6 * this.stride + var5;
         return (1.0D - var8) * (1.0D - var10) * this.data[var12] + var8 * (1.0D - var10) * this.data[var12 + this.stride] + var8 * var10 * this.data[var12 + this.nx * this.stride + this.stride] + (1.0D - var8) * var10 * this.data[var12 + this.nx * this.stride];
      }
   }
   ...
   public double[] interpolate(double var1, double var3, int[] var5, double[] var6) {
      ...
      var7 = Math.max(0, var7);
      var7 = Math.min(this.nx - 2, var7);
      int var8 = -((int)((this.top - var3) / this.dy));
      var8 = Math.max(0, var8);
      var8 = Math.min(this.ny - 2, var8);
      if (var7 < 0 && var8 < 0) {
         int var17 = 0;

         for(int var10 = var5.length; var17 < var10; ++var17) {
            var6[var17] = this.data[var5[var17]];
         }
         ...
         if (var7 < 0) {
            ...
            for(var12 = var5.length; var18 < var12; ++var18) {
               var13 = this.nx * var8 * this.stride + var5[var18];
               var6[var18] = (1.0D - var9) * this.data[var13] + var9 * this.data[var13 + this.stride];
            }
            ...
            for(var12 = var5.length; var18 < var12; ++var18) {
               var13 = var7 * this.stride + var5[var18];
               var6[var18] = (1.0D - var9) * this.data[var13] + var9 * this.data[var13 + this.stride];
            }
            ...
            for(int var14 = var5.length; var13 < var14; ++var13) {
               ...
               int var16 = this.nx * var8 * this.stride + var7 * this.stride + var15;
               var6[var13] = (1.0D - var9) * (1.0D - var11) * this.data[var16] + var9 * (1.0D - var11) * this.data[var16 + this.stride] + var9 * var11 * this.data[var16 + this.nx * this.stride + this.stride] + (1.0D - var9) * var11 * this.data[var16 + this.nx * this.stride];
            }
   ...
   public double[][][] getData() {
      double[][][] var1 = new double[1][1][];
      var1[0][0] = this.data;
      return var1;
   }

   public double[] getZRange(int var1) {
      double var2 = this.data[var1];
      double var4 = var2;

      for(int var6 = 0; var6 < this.ny; ++var6) {
         int var7 = var6 * this.nx + var1;

         for(int var8 = 0; var1 < this.nx; ++var8) {
            double var9 = this.data[var7 + var8];
            if (var9 > var4) {
               var4 = var9;
            }
