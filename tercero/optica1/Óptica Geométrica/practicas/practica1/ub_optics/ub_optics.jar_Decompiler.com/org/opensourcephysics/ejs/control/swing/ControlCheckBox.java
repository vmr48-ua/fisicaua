...
public class ControlCheckBox extends ControlSwingElement {
   ...
   public ControlCheckBox(Object var1) {
      super(var1);
   }

   protected Component createVisual(Object var1) {
      if (var1 instanceof JCheckBox) {
         this.checkbox = (JCheckBox)var1;
      } else {
         this.checkbox = new JCheckBox();
      }

      this.defaultStateSet = false;
      this.internalValue = new BooleanValue(this.defaultState = this.checkbox.isSelected());
   ...
   public void setValue(int var1, Value var2) {
      switch(var1) {
      case 0:
         this.checkbox.setText(var2.getString());
         break;
      case 1:
         ...
         this.checkbox.setIcon(this.getIcon(this.imageFile = var2.getString()));
         break;
      case 2:
         ...
         this.checkbox.setSelectedIcon(this.getIcon(this.selectedimageFile = var2.getString()));
         break;
      case 3:
         this.checkbox.setHorizontalAlignment(var2.getInteger());
         break;
      case 4:
         this.checkbox.setSelected(this.internalValue.value = var2.getBoolean());
         break;
      case 5:
