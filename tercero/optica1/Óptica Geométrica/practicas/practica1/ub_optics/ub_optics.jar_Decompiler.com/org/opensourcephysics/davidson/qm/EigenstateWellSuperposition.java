...
public class EigenstateWellSuperposition implements QMSuperposition {
   ...
   public EigenstateWellSuperposition(int var1, double var2, double var4) {
   ...
   public boolean setCoef(double[] var1, double[] var2) {
      ...
      this.recoef = new double[var12];
      this.imcoef = new double[var12];
      System.arraycopy(var1, 0, this.recoef, 0, var12);
      System.arraycopy(var2, 0, this.imcoef, 0, var12);
      this.eigenstates = new double[var12][var4];

      for(int var5 = 0; var5 < var12; ++var5) {
         double[] var6 = this.eigenstates[var5];
         double var7 = 0.0D;
         double var9 = 3.141592653589793D * (double)(var5 + 1) / (double)(this.x.length - 1);

         for(int var11 = 0; var11 < var4; ++var11) {
            var6[var11] = Math.sqrt(2.0D / this.L) * Math.sin(var7);
            var7 += var9;
         }
      }
   ...
   public double getEigenValue(int var1) {
      return (double)((var1 + 1) * (var1 + 1)) * 9.869604401089358D * this.energyScale / this.L / this.L;
   }
   ...
   public void update(double var1) {
      ...
      if (this.eigenstates.length != 0) {
         double var3 = -9.869604401089358D * this.energyScale * var1 / this.L / this.L;
         int var5 = 0;

         for(int var6 = this.recoef.length; var5 < var6; ++var5) {
            double var7 = this.recoef[var5];
            double var9 = this.imcoef[var5];
            double var11 = var3 * (double)(var5 + 1) * (double)(var5 + 1);
