...
public class DibujoDiagramasFL extends Canvas {
   ...
   void dibujaDiagramas(Graphics var1) {
      ...
      int var22 = ExactoFL.numRayos;
      int var23 = ExactoFL.numColores;
      int var24 = FuncionesExactasFL.numSup;
      int var25 = var22 * var23;
      double[] var30 = new double[2];
      double var31 = 0.03D;
      double var12 = FuncionesExactasFL.imagParax + ExactoFL.valZImag;
      ...
      for(var5 = 0; var5 < 2; ++var5) {
         ...
         for(int var4 = 0; var4 < var23; ++var4) {
            var18[var5] = FuncionesExactasFL.cRayo[var5][var4][var24 + 1][0] * var12 + FuncionesExactasFL.dRayo[var5][var4][var24 + 1][0];

            for(var3 = 0; var3 < var22; ++var3) {
               if (FuncionesExactasFL.pasa[var5][var4][var24][var3] != 0) {
                  double var14 = FuncionesExactasFL.aRayo[var5][var4][var24 + 1][var3] * var12 + FuncionesExactasFL.bRayo[var5][var4][var24 + 1][var3];
                  int var8 = (int)(90.0D * var14 / ExactoFL.escala);
                  double var16 = FuncionesExactasFL.cRayo[var5][var4][var24 + 1][var3] * var12 + FuncionesExactasFL.dRayo[var5][var4][var24 + 1][var3] - var18[var5];
                  int var9 = -((int)(90.0D * var16 / ExactoFL.escala));
         ...
         ExactoFL.labelValMerito[var5].setText(var30[var5] + " %");
