...
public class DibujoSistemaFL extends Canvas {
   ...
   public void paint(Graphics var1) {
      ...
      int var26 = AnteproyectoFL.numUltimaLente;
      int var27 = AnteproyectoFL.numUltimoElemento;
      ...
      for(int var18 = 0; var18 < 2; ++var18) {
         int var5 = AnteproyectoFL.numTramos[var18];
         if (var5 < 2) {
            break;
         }

         if (SistemaFL.existeObjeto[var18] != 0) {
            int var2;
            int var3;
            int var4;
            int var7;
            ...
            int var16;
            int var17;
            for(var3 = 0; var3 < 22 && (SistemaFL.valYObj[var18] != 0.0D || var3 <= 10); ++var3) {
               if (var18 == 0 && var3 == 0) {
               ...
               for(var4 = 0; var4 < var5; ++var4) {
                  var2 = AnteproyectoFL.tramo[var18][var4];
                  var7 = AnteproyectoFL.tramo[var18][var4 + 1];
                  if (var2 == 0) {
                     if (!(SistemaFL.zObjeto[var18] < 0.0D) && SistemaFL.real[var18] != 0 && !(SistemaFL.zObjeto[var18] >= 1.0E10D)) {
                        var13 = (int)(SistemaFL.zObjeto[var18] / 2.0D);
                        if (var3 <= 10) {
                           var16 = this.eje;
                        } else {
                           var16 = this.eje - (int)(SistemaFL.valYObj[var18] * 2.0D);
                        }
                     } else {
                        var13 = 0;
                        var16 = this.eje - (int)(AnteproyectoFL.bpRayo[var18][0][var3] * 2.0D);
                     }
                  } else {
                     if (AnteproyectoFL.pasa[var18][var2][var3] == 0) {
                        break;
                     }

                     var13 = (int)(AnteproyectoFL.zpRayo[var18][var2][var3] / 2.0D);
                     var16 = this.eje - (int)(AnteproyectoFL.ypRayo[var18][var2][var3] * 2.0D);
                  }

                  var14 = (int)(AnteproyectoFL.zaRayo[var18][var7][var3] / 2.0D);
                  var17 = this.eje - (int)(AnteproyectoFL.yaRayo[var18][var7][var3] * 2.0D);
                  var31.drawLine(var13, var16, var14, var17);
               }
            }

            var7 = AnteproyectoFL.tramo[var18][1];
            if (AnteproyectoFL.verObjetoVirtual == 1 && SistemaFL.real[var18] == 0 && var18 == 0 && SistemaFL.existeObjeto[1] == 0 && SistemaFL.zObjeto[0] > AnteproyectoFL.zaRayo[var18][var7][0]) {
               var31.setStroke(var29);
               var14 = (int)(SistemaFL.zObjeto[var18] / 2.0D);
               var17 = this.eje - (int)(SistemaFL.valYObj[var18] * 2.0D);
               ...
               for(var3 = 0; var3 < 11; ++var3) {
                  var13 = (int)(AnteproyectoFL.zaRayo[var18][var7][var3] / 2.0D);
                  var16 = this.eje - (int)(AnteproyectoFL.yaRayo[var18][var7][var3] * 2.0D);
            ...
            for(var4 = 0; var4 < var5; ++var4) {
               var2 = AnteproyectoFL.tramo[var18][var4];
               var7 = AnteproyectoFL.tramo[var18][var4 + 1];
               var13 = (int)(AnteproyectoFL.zImag[var18][var2] / 2.0D);
               var16 = this.eje - (int)(AnteproyectoFL.yImag[var18][var2] * 2.0D);
               if (AnteproyectoFL.zImag[var18][var2] > SistemaFL.valZE[var2] && AnteproyectoFL.zImag[var18][var2] < SistemaFL.valZE[var7]) {
                  var31.drawLine(var13, this.eje, var13, var16);
               }

               if (AnteproyectoFL.verImagenVirtual == 1 && var4 == var5 - 1 && var18 == 0 && SistemaFL.existeObjeto[1] == 0 && AnteproyectoFL.zImag[var18][var27] < SistemaFL.valZE[var26]) {
                  var31.setStroke(var29);
                  var31.drawLine(var13, this.eje, var13, var16);
                  var31.setColor(Color.green);

                  for(var3 = 0; var3 < 11; ++var3) {
                     if (AnteproyectoFL.pasa[var18][var26][var3] != 0) {
                        var14 = (int)(AnteproyectoFL.zpRayo[var18][var26][var3] / 2.0D);
                        var17 = this.eje - (int)(AnteproyectoFL.ypRayo[var18][var26][var3] * 2.0D);
      ...
      if (SistemaFL.existeObjeto[0] != 0) {
         if (SistemaFL.existeObjeto[1] != 1) {
            var31.setColor(Color.white);
            int var32 = (int)(SistemaFL.valZE[AnteproyectoFL.numDiafragma] / 2.0D);
            var31.drawString("D.A.", var32 - 10, this.eje - 75);
            var31.setColor(Color.magenta);
            int var34 = (int)(AnteproyectoFL.zPE / 2.0D) - 1;
            int var33 = (int)AnteproyectoFL.DPE;
            if (var33 < 100) {
            ...
            int var35 = (int)(AnteproyectoFL.zPS / 2.0D) + 1;
            var33 = (int)AnteproyectoFL.DPS;
            if (var33 < 100) {
      ...
      for(int var2 = 1; var2 < 7; ++var2) {
         ...
         if (SistemaFL.tipoE[var2] == 1) {
            if (SistemaFL.valPE[var2] != 0.0D) {
               double var19 = SistemaFL.radioDib[var2];
               var21 = (double)AnteproyectoFL.diamMax / 2.0D;
               var9 = SistemaFL.valZE[var2];
               double var7 = SistemaFL.espesor[var2];
               double var11 = var9 - var7 / 2.0D;
               double var13 = var9 + var7 / 2.0D;
               double var15 = var11 + SistemaFL.valDibPE[var2];
               double var17 = var13 - SistemaFL.valDibPE[var2];
         ...
         } else if (SistemaFL.valDE[var2] != (double)AnteproyectoFL.diamMax) {
            var9 = SistemaFL.valZE[var2];
            var21 = SistemaFL.valDE[var2] / 2.0D;
