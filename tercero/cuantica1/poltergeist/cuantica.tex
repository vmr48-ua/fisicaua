...
\clearpage
  ...
  \section{Ecuación de continuidad}
    ...
    \definicion{Ecuación de continuidad}{
      ...
      $\dfrac{\partial\mcP(x,t)}{\partial t}=\dfrac{\partial}{\partial t}\left(\Psi^*\cdot\Psi\right)=
      \dfrac{\partial\Psi^*}{\partial t}\cdot\Psi +\Psi *\dfrac{\partial\Psi}{\partial t} \implies
      \begin{rcases}
