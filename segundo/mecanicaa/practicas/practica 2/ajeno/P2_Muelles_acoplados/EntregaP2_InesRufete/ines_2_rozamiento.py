...
tf=30.0             #tiempo de simulacion
mi=1.0/m              # Inversa de la masa

#añadimos rozamiento
alpha = 0.05
beta = 0.05
gamma1=alpha         #muelles exteriores
gamma2=beta        #muelle central
...
par=[mi,k,kp,gamma1,gamma2]

# Valores iniciales
z1_0= 0.1  # Desplazamiento inicial masa 1
z2_0= 0  # Desplazamiento inicila masa 2
...
def double_pendulum(z,t,par):
    ...
    dzdt=[z3,
          z4,
          (-k*z1+kp*(z2-z1))*mi - gamma1*z3 + gamma2*(z4 - z3),
          (-k*z2-kp*(z2-z1))*mi -gamma1*z4 - gamma2*(z4 - z3) ]
    return dzdt
