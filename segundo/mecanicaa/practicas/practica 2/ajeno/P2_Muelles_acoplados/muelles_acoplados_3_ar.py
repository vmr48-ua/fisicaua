...
kp=10.0 # Constante elástica del muelle que une ambas masas
...
def double_pendulum(z,t,par):
    z1,z2,z3,z4=z  
    dzdt=[z3,z4,(-k*z1+kp*(z2-z1))*mi + g,(-k*z2-kp*(z2-z1))*mi + g] #para agregar garvedad sumar a ambos términos
    return dzdt
...
#ax2.set_xlim(0.4,1.) #limites del eje x
line1, = ax2.plot(fr,X_m)
#tienen que salir 2 picos si no es que se ve muy poco en la gráfica y hay que modificar los limites del eje x
...
plt.plot(t, U_g, c='g', label='Energía potencial gravitatoria')
plt.legend(loc='best')
