...
line4, = ax11[1, 1].plot( z[0:nfinal,0],z[0:nfinal,1], color='y')
...
ax41[1,1].set_xlabel('x ')
ax41[1,1].set_ylabel('y ', color='b', fontsize=12)
line4, = ax41[1, 1].plot( az[0:nafinal,0], az[0:nafinal,1], color='y')
plt.show()
...
line4, = ax81[1, 1].plot( az[0:nfinal,0], az[0:nfinal,1], color='y')
plt.show()
