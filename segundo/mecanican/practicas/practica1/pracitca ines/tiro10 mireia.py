...
velin =200.0         # velocidad de disparo
...
# Calcular los módulos de la aceleración centrípeta y de Coriolis
aceleracion_centrípeta = np.sqrt(ome2radx**2 + ome2radz**2)
aceleracion_coriolis = np.sqrt(omex**2 + omez**2)

# Imprimir los resultados
print("Módulo de la aceleración centrípeta:", aceleracion_centrípeta)
print("Módulo de la aceleración de Coriolis:", aceleracion_coriolis)
...
# Trayectoria 
fig.suptitle('Trayectoria con rotacion')
fig, ax11 = plt.subplots(2,2)
fig.suptitle('Trayectoria corregido')
...
ax11[1,1].set_ylabel('y( m)', color='b', fontsize=12)
line4, = ax11[1, 1].plot( z[:,0],z[:,1]**2, color='y')
#plt.savefig("trayectoriassincoriolis.jpg", bbox_inches='tight')
plt.show()

#Trayectoria tiro puro
fig.suptitle('Trayectoria tiro puro')
...
ax41[1,1].set_ylabel('y(m) ', color='b', fontsize=12)
line4, = ax41[1, 1].plot( az[0:nafinal,0], az[0:nafinal,1]**2, color='y')
plt.show()


# Diferencias
fig.suptitle('Diferencias')
...
ax81[1,1].set_ylabel('y(m)', color='b', fontsize=12)
