...
#ome2radx=0 #para anular componente centripeta aceleracion
#ome2radz=0
...
def tiro(z,t,par): #tiro con coriolis y centripeto
    z1,z2,z3,z4,z5,z6=z  
    dzdt=[z4,z5,z6, 
          ome2radx +2*z5*omez,
          2*(z6*omex-z4*omez),
...
def tirog(az,at,par): #tiro solo gravedad
...
fig.suptitle('diferencias trayectorias')
...
fig.suptitle('velocidad corregido')
...
fig.suptitle('las posiciones /20000 respecto a t')
...
#
fig= plt.figure() #trayectoria tiro corregido
#fig.suptitle('Trayectoria corregido')
ax= fig.gca(projection='3d')
ax.view_init(20,-40)
ax.plot3D(ex,ey,ez)
#plt.savefig("trayectoria3danguloaumento.jpg", bbox_inches='tight')

fig= plt.figure() #trayectoria tiro puro
fig.suptitle('Trayectoria puro')
ax= fig.gca(projection='3d')
ax.view_init(20,-40)
