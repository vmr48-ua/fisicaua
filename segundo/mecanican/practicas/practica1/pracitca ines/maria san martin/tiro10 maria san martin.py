...
pla=0.0  # angulo plano 0º Sur eje X, 90º Este eje y, 180º Sur 270º Oeste
...
ome2radx= omega**2*radi*np.cos(ralat)*np.sin(ralat)   #componente x producto vectorial omega x (omega x radio)
ome2radz= omega**2*omega*radi*np.cos(ralat)**2      #componente z producto vectorial omega x (omega x radio)

#Los términos de coriolis son los que llevan un dos delante
...
print('evolucion de los desplazamientos x1 y x2 con el tiempo')
