...
#integramos z=odeint(tiro,z0,t,args=(par,),atol=abserr, rtol=relerr)
#siendo tiro la funcion
#args la lista con las constantes del proceso de integracion
#atol el parametro que indica valores absolutos en la integracion
#y rtol el parametro que indica valores relativos en la integracion
z=odeint(tiro,z0,t,args=(par,),atol=abserr, rtol=relerr)
zcentripeto=odeint(tirocentripeto,z0,t,args=(par,),atol=abserr, rtol=relerr)
zcoriolis=odeint(tirocoriolis,z0,t,args=(par,),atol=abserr, rtol=relerr)
...
"AÑADIDO"
for i in range (0,nt): 
    if zcentripeto[i-1,2]*zcentripeto[i,2] <0 : nfinal=i

print (' Tiro  contando rotación centripeto')
print ('n=',nfinal)
print ( 'xfcentripeto=' , zcentripeto[nfinal,0], '  yfcentripeto= ' , zcentripeto[nfinal,1] , '  zfcentripeto= ', zcentripeto[nfinal,2])


for i in range (0,nt): 
    if zcoriolis[i-1,2]*zcoriolis[i,2] <0 : nfinal=i

print (' Tiro  contando rotación coriolis')
print ('n=',nfinal)
print ( 'xfcoriolis=' , zcoriolis[nfinal,0], '  yfcoriolis= ' , zcoriolis[nfinal,1] , '  zfcoriolis= ', zcoriolis[nfinal,2])
...
distcentripeto = sqrt(  (zcentripeto[nfinal,0] -az[nafinal,0])**2  +(zcentripeto[nfinal,1] -az[nafinal,1])**2  )
distcoriolis = sqrt(  (zcoriolis[nfinal,0] -az[nafinal,0])**2  +(zcoriolis[nfinal,1] -az[nafinal,1])**2  )
print ('Error en el tiro =', dist)
print ('Error en el tiro centripeto =', distcentripeto)
print ('Error en el tiro coriolis =', distcoriolis)
