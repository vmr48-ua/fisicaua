...
plt.ylabel('$L$')
plt.xlabel('$t (s)$')
plt.title('Precesión en el eje 1')
#plt.grid()
plt.show()

#Damos los valores iniciales y finales para ver que hay un leve movimiento
print('momento angular inicial:',momang(I1, I2, I3, y1[:,0][0],y1[:,1][0],y1[:,2][0]),'\n'
      'momento angular final:',momang(I1, I2, I3, y1[:,0][-1],y1[:,1][0],y1[:,2][0]))
...
plt.ylabel('$L$')
plt.xlabel('$t (s)$')
plt.title('Precesión en el eje 3')
plt.show()
...
plt.plot(t,y2[:,0],c='orange',label='$\omega_1$')
#plt.plot(t,y2[:,1],label='$\omega_2$')
plt.plot(t,y2[:,2],c='g',label='$\omega_3$')
plt.grid()
plt.xlabel('t')
plt.ylabel('$\omega$')
plt.title('Velocidades angulares para el eje 2')
plt.legend(loc='best')
plt.show()
...
plt.figure()
plt.plot(t,Ec(I1, I2, I3, y2[:,0],y2[:,1],y2[:,2]),label='Energía cinética')
plt.legend(loc='best')
plt.ylim(0,4)
plt.ylabel('$E_{cinética}$')
plt.xlabel('$t (s)$')
...
plt.figure()
plt.plot(t,momang(I1, I2, I3,y2[:,0],y2[:,1],y2[:,2]),label='Módulo del momento angular')
plt.legend(loc='best')
plt.ylim(0,4)
plt.ylabel('$L$')
plt.xlabel('$t (s)$')
